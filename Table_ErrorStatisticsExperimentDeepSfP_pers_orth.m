...
%%
fprintf('Indoor & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n & Orth. & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    IndoorPers.MAE, IndoorPers.SD, IndoorPers.RMSE, ...
    IndoorOrth.MAE, IndoorOrth.SD, IndoorOrth.RMSE);
fprintf('\\cdashline{1-5}\n');
fprintf('\\addlinespace[2pt]\n');
fprintf('Outdoor cloudy & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & Orth. & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    Outdoor_cloudyPers.MAE, Outdoor_cloudyPers.SD, Outdoor_cloudyPers.RMSE, ...
    Outdoor_cloudyOrth.MAE, Outdoor_cloudyOrth.SD, Outdoor_cloudyOrth.RMSE);
fprintf('\\cdashline{1-5}\n');
fprintf('\\addlinespace[2pt]\n');
fprintf('Outdoor sunny & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & Orth. & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    Outdoor_sunnyPers.MAE, Outdoor_sunnyPers.SD, Outdoor_sunnyPers.RMSE, ...
    Outdoor_sunnyOrth.MAE, Outdoor_sunnyOrth.SD, Outdoor_sunnyOrth.RMSE);
