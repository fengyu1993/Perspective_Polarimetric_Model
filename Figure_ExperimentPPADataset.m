...
%%
exportgraphics(figPers, 'fig_exp_PPA_dataset_Error_Normal_pers.png', 'Resolution', plotParameter.Resolution);
exportgraphics(figOrth, 'fig_exp_PPA_dataset_Error_Normal_orth.png', 'Resolution', plotParameter.Resolution);
exportgraphics(figIJCV, 'fig_exp_PPA_dataset_Error_Normal_IJCV.png', 'Resolution', plotParameter.Resolution);
