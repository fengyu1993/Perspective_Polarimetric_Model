%% Real Data (DeepSfP Dataset) Complex Surfaces Comparision: save spdp data
clc; clear; close all;
%%
...
for caseNum = 1 : length(index.name)
    ...
    switch flag_case
        case 1   
            saveName = ['./Data/Data_DeepSfP_dataset_indoor_', caseName ,'_test_A_FXY_spdp.mat'];
        case 2
            saveName = ['./Data/Data_DeepSfP_dataset_outdoor_cloudy_', caseName ,'_test_A_FXY_spdp.mat'];
        case 3
            saveName = ['./Data/Data_DeepSfP_dataset_outdoor_sunny_', caseName ,'_test_A_FXY_spdp.mat'];
    end
