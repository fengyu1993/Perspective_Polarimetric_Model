...
%%
fprintf('Orth. & $%.3f$ & $%.3f$ & $%.3f$  & & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    PPAOrth.MAE, PPAOrth.SD, PPAOrth.RMSE, ...
    IJCVOrth.MAE, IJCVOrth.SD, IJCVOrth.RMSE);
fprintf('GMPC & $%.3f$ & $%.3f$ & $%.3f$  & & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    PPAIJCV.MAE, PPAIJCV.SD, PPAIJCV.RMSE, ...
    IJCVIJCV.MAE, IJCVIJCV.SD, IJCVIJCV.RMSE);
fprintf('Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ \\\\ \n', ...
    PPAOurs.MAE, PPAOurs.SD, PPAOurs.RMSE, ...
    IJCVOurs.MAE, IJCVOurs.SD, IJCVOurs.RMSE);
