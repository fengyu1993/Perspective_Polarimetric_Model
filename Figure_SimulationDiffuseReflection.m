...
h = imagesc(Plane.error_N_angle_dp); set(h, 'AlphaData', Plane.Mask); set(ax, 'Color', 'w'); 
...
h = imagesc(Plane.error_N_angle_dp_orth); set(h, 'AlphaData', Plane.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
...
h = imagesc(Plane.error_N_angle_dp_IJCV); set(h, 'AlphaData', Plane.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(ax,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Hemisphere.error_N_angle_dp); set(h, 'AlphaData', Hemisphere.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(gca,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Hemisphere.error_N_angle_dp_orth); set(h, 'AlphaData', Hemisphere.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(ax,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Hemisphere.error_N_angle_dp_IJCV); set(h, 'AlphaData', Hemisphere.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(ax,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Random.error_N_angle_dp); set(h, 'AlphaData', Random.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(gca,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Random.error_N_angle_dp_orth); set(h, 'AlphaData', Random.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(ax,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
...
h = imagesc(Random.error_N_angle_dp_IJCV); set(h, 'AlphaData', Random.Mask); set(ax, 'Color', 'w'); 
axis equal; axis([0, col, 0, row]);
set(ax, 'xtick', 0:400:1200, 'ytick', 0:250:1000, 'FontSize', plotParameter.FontSize  * plotParameter.Scale, 'FontName', 'Times New Roman', 'LineWidth', plotParameter.LineWidth );
set(ax,'LineWidth', plotParameter.LineWidth );
xtickangle(0);
