...
%%
% box
fprintf('Box & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
...
% dragon
fprintf('Dragon & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    dragon_pers.MAE, dragon_pers.SD, dragon_pers.RMSE, ...
    dragon_DeepSfP.MAE, dragon_DeepSfP.SD, dragon_DeepSfP.RMSE);
fprintf('\\cdashline{1-5}\n');
fprintf('\\addlinespace[2pt]\n');
% % father christmas
% fprintf('Father Christmas & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
%     father_christmas_pers.MAE, father_christmas_pers.SD, father_christmas_pers.RMSE, ...
%     father_christmas_DeepSfP.MAE, father_christmas_DeepSfP.SD, father_christmas_DeepSfP.RMSE);
% fprintf('\\cdashline{1-5}\n');
% fprintf('\\addlinespace[2pt]\n');
% flamingo
fprintf('Flamingo & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    flamingo_pers.MAE, flamingo_pers.SD, flamingo_pers.RMSE, ...
    flamingo_DeepSfP.MAE, flamingo_DeepSfP.SD, flamingo_DeepSfP.RMSE);
fprintf('\\cdashline{1-5}\n');
fprintf('\\addlinespace[2pt]\n');
% horse
fprintf('Horse & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
    horse_pers.MAE, horse_pers.SD, horse_pers.RMSE, ...
    horse_DeepSfP.MAE, horse_DeepSfP.SD, horse_DeepSfP.RMSE);
% fprintf('\\cdashline{1-5}\n');
% fprintf('\\addlinespace[2pt]\n');
% % vase
% fprintf('Vase & Ours & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$ & $\\mathbf{%.3f}$  \\\\\n  & DeepSfP & $%.3f$ & $%.3f$ & $%.3f$ \\\\ \n', ...
%     vase_pers.MAE, vase_pers.SD, vase_pers.RMSE, ...
%     vase_DeepSfP.MAE, vase_DeepSfP.SD, vase_DeepSfP.RMSE);


% 
% rad2deg(box_DeepSfP.MAE)
% rad2deg(dragon_DeepSfP.MAE)
% rad2deg(father_christmas_DeepSfP.MAE)
% rad2deg(flamingo_DeepSfP.MAE)
% rad2deg(horse_DeepSfP.MAE)
% rad2deg(vase_DeepSfP.MAE)
